...
const CantonValais = () => (
  <CantonPage
    ...
    title="Soins Énergétiques Valais — Kundalini & Chamanisme | 1h offerte"
    description="Soins énergétiques, activation Kundalini, kinésiologie et accompagnement burn-out pour le Valais romand : Sion, Sierre, Martigny, Monthey, Verbier. Séances à distance ou au cabinet à Bevaix (NE). Prix libre. Première heure découverte offerte. ★ 4,9/5 sur Google."
