...
const PageUne = () => {
  return (
    <Layout>
      <Seo
        title="Soins Énergétiques & Libération des Blocages — Suisse Romande"
        description="Soins énergétiques en Suisse romande : libération des blocages physiques et émotionnels, harmonisation des chakras, respiration alchimique, activation Kundalini. À distance ou en présentiel à Bevaix."
        path="/page-une"
        keywords="soins énergétiques Suisse romande, libération blocages émotionnels, harmonisation chakras Neuchâtel"
      />
